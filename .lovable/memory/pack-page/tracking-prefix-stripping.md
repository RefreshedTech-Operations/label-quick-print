...
description: Strips 15-char prepended prefixes from scanned tracking >30 chars, exempts UPS (1Z) tracking
type: feature
---
...
- If the scanned string length exceeds 30 characters, strip the first 15 characters
