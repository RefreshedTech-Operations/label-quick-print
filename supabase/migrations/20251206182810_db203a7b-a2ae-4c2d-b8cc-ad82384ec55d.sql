-- Update search_shipments function to support 'non_bundled' filter
...
-- Update get_shipments_stats function to support 'non_bundled' filter
CREATE OR REPLACE FUNCTION public.get_shipments_stats(search_term text DEFAULT NULL::text, p_show_date date DEFAULT NULL::date, p_printed boolean DEFAULT NULL::boolean, p_filter text DEFAULT 'all'::text)
