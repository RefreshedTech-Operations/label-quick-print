...
BEGIN
  ...
  archived AS (
    INSERT INTO shipments_archive (
      ...
      shipengine_label_id, shipping_provider, shipping_cost, unit_id, shipping_price
    )
    SELECT 
      ...
      s.shipengine_label_id, s.shipping_provider, s.shipping_cost, s.unit_id, s.shipping_price
    FROM shipments s
